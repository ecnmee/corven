...
See [CONTRIBUTING.md](./CONTRIBUTING.md). Note: the project isn't accepting external code contributions yet, since the Core API hasn't shipped a first version — but issues and discussion are welcome.
